    ...
    public partial class AppShell : Shell
    {
        public AppShell()
        {
            ...
            if (DeviceInfo.Idiom == DeviceIdiom.Desktop)
            {
                ...
                Routing.RegisterRoute(nameof(Views.Desktop.ServerDetails), typeof(Views.Desktop.Servers));
            ...
            else if(DeviceInfo.Idiom == DeviceIdiom.Phone)
            {
                ...
                Routing.RegisterRoute(nameof(Views.Mobile.ServerDetails), typeof(Views.Mobile.Servers));
