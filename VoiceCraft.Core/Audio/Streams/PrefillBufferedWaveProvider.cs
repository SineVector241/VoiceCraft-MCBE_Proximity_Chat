...
{
    public class PrefillBufferedWaveProvider : IWaveProvider
    {
        ...
        public PrefillBufferedWaveProvider(WaveFormat waveFormat)
        {
        ...
        /// <summary>
        /// Number of bytes to store before releasing data.
        /// </summary>
        public int PrefillBytesTarget { get; set; }
        ...
        {
            int read = 0;
            if (circularBuffer != null && BufferedBytes >= PrefillBytesTarget) // not yet created
            {
